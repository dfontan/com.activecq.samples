...
@Service
public class SamplePrimaryTypeResourceDecorator extends AbstractPrimaryTypeResourceDecorator implements ResourceDecorator {
    ...
    public Resource decorate(Resource resource, HttpServletRequest request) {
        ...
        map.put("PRIMARY_TYPE", "WHOA! this is a nt:unstructured node!");
