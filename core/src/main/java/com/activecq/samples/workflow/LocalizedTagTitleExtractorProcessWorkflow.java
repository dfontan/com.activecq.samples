...
public class LocalizedTagTitleExtractorProcessWorkflow implements WorkflowProcess {
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap args) throws WorkflowException {
        ...
        // Get RR for the Workflow's executing session
        ...
        try {
            ...
            if(contentResource == null) {
                log.error("Could not find a valid content resource node from payload: {}", resource.getPath());
                return;
            }
            ...
            if(!ArrayUtils.isEmpty(tags)) {
                ...
                // Get the New Localized Tag Titles
    ...
    private List<String> tagPathsToLocalizedTagTitles(String[] tagPaths, Locale locale, TagManager tagManager) {
        ...
        for(String tagPath : tagPaths){
            ...
            int count = StringUtils.countMatches(tagPath, "/");
